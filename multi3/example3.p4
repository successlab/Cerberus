...
action reg_c5_plus_action(){
	reg_c5_res = reg_c5_plus.execute(reg_c5_key);
}
...
action reg_c5_minus_action(){
	reg_c5_res = reg_c5_minus.execute(reg_c5_key);
}
...
action reg_c_reset(bit<32> slices){
...
action normal_timer(){
		global_time1 = ig_prsr_md.global_tstamp[31:31];  //about 8 seconds

...
bit<32> extracted_reg_c2_res_slice4 = 0;
...
bit<32> extracted_reg_c5_res_slice5 = 0;
bit<32> extracted_reg_c5_res_slice6 = 0;
bit<32> extracted_reg_c5_res_slice7 = 0;
bit<32> extracted_reg_c5_res_slice8 = 0;
bit<32> extracted_reg_c5_res_slice9 = 0;
...
action extract_reg_c2_slicing_action(bit<32> mask1, bit<32> mask2, bit<32> mask3, bit<32> mask4, bit<32> mask5, bit<32> mask6){
		...
		extracted_reg_c2_res_slice4= reg_c2_res & mask6;
}
...
action extract_reg_c5_slicing_action(bit<32> mask1, bit<32> mask2, bit<32> mask3, bit<32> mask4, bit<32> mask5, bit<32> mask6, bit<32> mask7, bit<32> mask8, bit<32> mask9, bit<32> mask10){
		...
		extracted_reg_c5_res_slice4= reg_c5_res & mask6;
		extracted_reg_c5_res_slice5= reg_c5_res & mask7;
		extracted_reg_c5_res_slice6= reg_c5_res & mask8;
		extracted_reg_c5_res_slice7= reg_c5_res & mask9;
		extracted_reg_c5_res_slice8= reg_c5_res & mask10;
		extracted_reg_c5_res_slice9= reg_c5_res & mask11;
}
...
table check_dns_ssdp_nta_mem_quic_q_table{
	key = {
...
action check_memr_setflag(){
	memr_flag = 1;
}
action check_quicr_setflag(){
	quicr_flag = 1;
}
table check_dns_ssdp_nta_mem_quic_r_table{
	key = {
		hdr.ipv4.protocol: exact;
...
table reg_c5_dyn_table{
	key = {
		...
		hdr.tcp.flags: exact; //ack/rst/fin
		ig_intr_md.resubmit_flag: exact;
	}
	actions = {
		reg_c5_merge;
...
table slowloris1_classification_table{
	key = {
		extracted_reg_c2_res_slice4: exact;
	}
	actions = {
		syn_setMflag;
	}
    ...
    apply {
		@stage(0){
			...
			if(is_blocked == 0){
				...
				slowloris_1_2_classification_table.apply();
				slowloris_2_2_classification_table.apply();
				if (extracted_reg_c5_res_slice6 == 0 && slowloris_flag == 1) {
					slowloris_3__Mflag = 0;
				}
				else{
					slowloris_3__Mflag = slowloris_flag;
				}
				if (extracted_reg_c5_res_slice7 == 0 && slowloris_flag == 1) {
					slowloris_4__Mflag = 0;
				}
				else{
					slowloris_4__Mflag = slowloris_flag;
				}
				if (extracted_reg_c5_res_slice8 == 0 && slowloris_flag == 1) {
					slowloris_5__Mflag = 0;
				}
				else{
					slowloris_5__Mflag = slowloris_flag;
				}
